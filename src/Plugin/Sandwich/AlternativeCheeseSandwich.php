...
namespace Drupal\try_console\Plugin\Sandwich;
 ...
 * @Sandwich(
 *   id = "cheese_sandwich",
 *   description = @Translation("American style cheddar cheese drenched in heinz bbq sauce."),
 *   calories = "1400"
 * )
 */
class AlternativeCheeseSandwich extends SandwichBase implements ContainerFactoryPluginInterface {
  ...
  public function order(array $extras) {
    $ingredients = ['cheese', 'heinz bbq sauce'];
  ...
  public function description() {
    ...
    if ($this->day == 'Wed') {
      return $this->t("Some crap sandwich.");
    }
